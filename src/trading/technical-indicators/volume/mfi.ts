import { TypicalPrice } from '../chart_types/typical_price';
import { Indicator, IndicatorInput } from '../indicator';
import { CandleData } from '../types';
import FixedSizeLinkedList from '../utils/fixed_size_linked_list';
        ...
        this.generator = (function* () {
            ...
            while (true) {
                ...
                if (typicalPriceValue != null && previousTypicalPrice != null) {
                    typicalPriceValue > previousTypicalPrice ? (positionMoney = rawMoneyFlow) : (negativeMoney = rawMoneyFlow);
